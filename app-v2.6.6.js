...
} from "./firebase-service-v2.6.6.js";
...
ensureInstallButton();
if("serviceWorker" in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./service-worker-v2.6.6.js", { scope: "./", updateViaCache: "none" }).catch(()=>{}));
