...
} from "./firebase-service-v2.8.1.js";
...
async function submitAdmission(event){
  ...
  const input={studentId:value("a-student-id"),studentName:value("a-student-name"),dateOfBirth:value("a-dob"),gender:value("a-gender"),courseOrClass:value("a-course"),studentPhone:value("a-student-phone"),parentName:value("a-parent-name"),parentRelation:value("a-parent-relation"),parentPhone:value("a-parent-phone"),emergencyPhone:value("a-emergency-phone"),aadhaarLast4:value("a-aadhaar"),joiningDate:value("a-joining"),address:value("a-address"),notes:value("a-notes")};
