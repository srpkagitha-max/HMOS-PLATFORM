...
} from "./firebase-service-v2.7.0.js";
...
ensureInstallButton();
if("serviceWorker" in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./service-worker-v2.7.0.js", { scope: "./", updateViaCache: "none" }).catch(()=>{}));
