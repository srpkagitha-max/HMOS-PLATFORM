...
} from "./firebase-service-v3.2.2.js";
...
ensureInstallButton();
if("serviceWorker" in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./service-worker-v3.2.2.js", { scope: "./", updateViaCache: "none" }).catch(()=>{}));
